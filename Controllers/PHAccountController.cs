...
{
    [Authorize(AuthenticationSchemes = "PetHotel")]
    public class PHAccountController : Controller
    {
        private const string AUTHSCHEME = "PetHotel";
        ...
        private const string LASTLOGIN_SQL =
           @"UPDATE PHUser SET LastLogin=GETDATE() 
                        WHERE Email='{0}'";

        private const string ROLE_COL = "Role";
        private const string NAME_COL = "Name";

        private const string REDIRECT_CNTR = "PetHotel";
